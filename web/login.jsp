    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5" style="padding:0;">
                <form class="form-sign_in" action="Login.action" onSubmit="user_login()">
                    <h2 class="form-sign_in-heading text-center" style="margin-top:0;">洗衣网登录</h2>
                    <input id="user_tel" name="username" class="form-control" placeholder="请输入您的用户名或手机号" required
                           autofocus type="tel">
                    <br/>
                    <input id="user_pwd" name="password" class="form-control" placeholder="密码" required type="password">
                    <br/>
                    <button class="btn btn-lg  button btn-block" type="submit">登 录</button>
                    ...
                    <span class="deng_lv"><span class="curr" style="font-size: 40px;">☞</span>&nbsp;&nbsp;<a
                            href="register.jsp" class="curr" style="font-size: 15px;">注册</a></span>
                    <br/>
                    <br/>
                </form>
            </div>
